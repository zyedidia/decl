...
static struct argp_option options[] = {
    ...
    { "empty-metering",  ARG_empty_metering, 0,      0, "use 0 for metering" },
    { 0 },
};
...
parse_opt(int key, char* arg, struct argp_state* state)
{
    ...
    case ARG_bundle:
        ...
        break;
    case ARG_empty_metering:
        args->empty_metering = true;
        break;
    case ARG_meter:
...
main(int argc, char** argv)
{
    ...
    char* empty_metering = getenv("LFI_EMPTY_METERING");
    if (empty_metering && strcmp(empty_metering, "1") == 0)
        args.empty_metering = true;
