...
hyperfine --runs 4 --warmup 2 \
    "./target/aarch64-native-linux-musl/release/sp1-verify-std -groth16 $PROOF.proof $PROOF.pub $PROOF.vk" \
    "lfi-run --poc -- ./target/aarch64-decl_timer-linux-musl/release/sp1-verify-std -groth16 $PROOF.proof $PROOF.pub $PROOF.vk" \
    "lfi-run --poc -- ./target/aarch64-decl_branch-linux-musl/release/sp1-verify-std -groth16 $PROOF.proof $PROOF.pub $PROOF.vk" \
...
hyperfine --runs 4 --warmup 2 \
    "./target/aarch64-native-linux-musl/release/sp1-verify-std -plonk $PROOF.proof $PROOF.pub $PROOF.vk" \
    "lfi-run --poc -- ./target/aarch64-decl_timer-linux-musl/release/sp1-verify-std -plonk $PROOF.proof $PROOF.pub $PROOF.vk" \
    "lfi-run --poc -- ./target/aarch64-decl_branch-linux-musl/release/sp1-verify-std -plonk $PROOF.proof $PROOF.pub $PROOF.vk" \
